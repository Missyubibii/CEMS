<section id="deviceFormModal" class="hidden fixed inset-0 overflow-y-auto bg-gray-900/60 w-full">
    <div class="flex items-center justify-center min-h-screen px-4">
        <div class="bg-white rounded-lg shadow-lg p-6 w-full max-w-md">
            <h2 class="text-lg font-semibold text-gray-900 capitalize">Thêm thiết bị học</h2>
            <form id="deviceForm" class="gap-6 mt-4 sm:grid-cols-2">
                ...
                <div class="flex justify-end mt-6">
                    ...
                    <button type="submit" class="mr-2 px-8 py-2.5 leading-5 text-white transition-colors duration-300 transform bg-blue-700 rounded-md hover:bg-blue-500 focus:outline-none">Lưu</button>
                </div>
            </form>
        </div>
    </div>
